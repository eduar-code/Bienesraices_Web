        ...
        <div class="anuncio">
            ...
            <div class="contenido-anuncio">
                ...
                <ul class="iconos-caracteristicas">
                    ...
                    <li>
                        <img class="icono" class="icono" src="build/img/icono_estacionamiento.svg" alt="icono parking" loading="lazy">
                        <p>3</p>
                    </li>
                    <li>
                        <img class="icono" src="build/img/icono_dormitorio.svg" alt="icono bedrooms" loading="lazy">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p class="informacion-meta">Escrito el: <span>20/10/20225</span> por: <span>Admin</span> </p>
                    <p>
                        Consejos para construir una terrazza en el techo de tu casa
